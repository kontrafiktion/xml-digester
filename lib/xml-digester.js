...
;(function (xml_digester) {
  ...
  xml_digester.DefaultHandler = new DefaultHandler();
  xml_digester.OrderedElementsHandler = new OrderedElementsHandler();
  xml_digester.SkipElementsHandler = new SkipElementsHandler();
